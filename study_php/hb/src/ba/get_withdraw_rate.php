...
$rtn_ary['errmsg'] = '';
$rtn_ary['ba_id'] = $ba_id;
$rtn_ary['withdraw_min_amount'] = floatval($row['min_amount']) * $row['base_rate'] / get_la_base_unit();
$rtn_ary['withdraw_max_amount'] = floatval($row['max_amount']) * $row['base_rate'] / get_la_base_unit();
...
$rtn_ary['withdraw_rate_type'] = "1";
$rtn_ary['withdraw_tx_fee'] = $row['tx_fee'];
